-- Fixes: (1) plpgsql record-null gotcha dropped promo redemptions;
-- (2) the customer guard must bind only authenticated non-staff users,
--     not the service role or definer functions.
